...
/**
 *
 * The ClassEngine is entry point for model validation.
 *
 * Providing information about class members and annotations
 * for further validations. Those information are taken from
 * ClassInfo object and stored in Member class within Members
 * class.
 *
 */
